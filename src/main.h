...
//Added
static const int LAST_POW_TIME = 1582781471;
...
static const int64_t COIN_YEAR_REWARD = 40 * CENT; // 40 * CENT; // 40% per year dynamically reducing to 2% over a period 20 years and above
