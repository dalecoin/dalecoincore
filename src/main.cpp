...
#if defined(NDEBUG)
# error "DaleCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "DaleCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 0.05 * COIN;
        ...
        {
            nSubsidy = 250000 * COIN; // 250000 initial supply
        }
...
bool CBlock::AcceptBlock()
{
    ...
    else if (!IsProtocolV2(nHeight) && nVersion > 9)
