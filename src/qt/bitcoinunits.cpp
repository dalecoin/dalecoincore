...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DALC");
    case mBTC: return QString("mDALC");
    case uBTC: return QString::fromUtf8("μDALC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("DaleCoin");
    case mBTC: return QString("Milli-DaleCoin (1 / 1,000)");
    case uBTC: return QString("Micro-DaleCoin (1 / 1,000,000)");
    default: return QString("???");
    }
}
